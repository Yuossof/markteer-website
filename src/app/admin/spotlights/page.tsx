...
import SpotlightsGrid from "./SpotlightsGrid";
import SpotlightModal from "./SpotlightModal";
import { useSpotlightHandlers } from "./useSpotlightHandlers";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">Spotlights</h1>
              <p className="text-gray-600">Manage featured spotlights</p>
            </div>
            <button
        ...
        {isLoading ? (
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-12 text-center">
            <div className="max-w-sm mx-auto">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">No spotlights yet</h3>
              <p className="text-gray-600 text-sm mb-6">Get started by creating your first spotlight</p>
              <button
                onClick={() => handleOpenModal()}
