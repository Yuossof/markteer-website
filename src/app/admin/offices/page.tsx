...
import { useOfficeHandlers } from "./useOfficeHandlers";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">Offices</h1>
        ...
        {isLoading ? (
          <div className="flex items-center justify-center py-20">
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">Loading offices...</p>
            </div>
          </div>
        ) : offices.length === 0 ? (
          <div className="bg-white border border-gray-200 rounded-xl p-12 text-center">
            <div className="max-w-sm mx-auto">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">No offices yet</h3>
              <p className="text-gray-600 text-sm mb-6">Get started by creating your first office</p>
              <button
                onClick={() => handleOpenModal()}
